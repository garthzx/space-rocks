...
public class BaseActor extends Group
{
    ...
    /**
     * Not final. Still buggy as I can't implement a perfect dash ability.
     */
    public void dash()
    {
        setDeceleration(0);
        Vector2 dashDestination = new Vector2(velocityVec.x + getOriginX(), velocityVec.y + getOriginY());
        moveBy(dashDestination.x, dashDestination.y);
    }
    /**
     ...
     *  Declared static to simplify access.
     *  @param className name of a class that extends the BaseActor class
    ...
    public float getActorWidth(BaseActor ba)
    {
        return ba.getWidth();
    }
    public float getActorHeight(BaseActor ba)
    {
        return ba.getHeight();
    }
}